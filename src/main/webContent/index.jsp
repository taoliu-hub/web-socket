...
<head>
<meta charset="UTF-8">
<title>用WebSocket实时获知最新价格</title>
</head>
<body>
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket("ws://localhost:8089/web-socket/ws/bitcoinServer");
    ...
    function setMessageInnerHTML(innerHTML) {
        var demoData = eval("("+innerHTML+")");
        document.getElementById('price').innerHTML = demoData.price;
        document.getElementById('total').innerHTML = demoData.total;
    }
